 ...
 * 
 * <p><code>com.yigos.sso.client.filter.user</code> must be set before 
 * this filter in the filter chain.</p>
 * 
 * <p>This filter takes the init-param 
 * <code>com.yigos.sso.client.filter.authorizedUsers</code>, a 
...
public class SimpleCASAuthorizationFilter implements Filter {
	...
	public static final String AUTHORIZED_USER_STRING =
		"com.yigos.sso.client.filter.authorizedUsers";
	...
	private List<Object> authorizedUsers;
	...
	public void init(FilterConfig config) throws ServletException {
		...
		this.authorizedUsers = new ArrayList<Object>();

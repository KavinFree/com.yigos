...
class SpringAnnotationDrivenBeanDefinitionParser implements
		BeanDefinitionParser {

	private static final boolean jsr303Present = ClassUtils.isPresent(
			"javax.validation.Validator",
			SpringAnnotationDrivenBeanDefinitionParser.class.getClassLoader());
	...
	private static final boolean jackson2Present = ClassUtils.isPresent(
			...
			&& ClassUtils.isPresent("com.fasterxml.jackson.core.JsonGenerator",
					SpringAnnotationDrivenBeanDefinitionParser.class
							.getClassLoader());
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		mappedCsInterceptorDef.setRole(BeanDefinition.ROLE_INFRASTRUCTURE);// kavin

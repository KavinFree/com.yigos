...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		RootBeanDefinition handlerMappingDef = new RootBeanDefinition(YigosRequestMappingHandlerMapping.class);
		//modify end by kavin
		...
		//add start by kavin
		handlerMappingDef.getPropertyValues().add("basePackage", element.getAttribute("base-package"));
		//add end by kavin

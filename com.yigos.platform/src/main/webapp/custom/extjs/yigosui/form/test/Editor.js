Ext.define("Ext.ux.form.field.CKEditor", {
    ...
    CKConfig: {
        ...
        resize_enabled : false, resize_maxHeight : 500, resize_maxWidth : 1000, resize_minHeight : 200, resize_minWidth : 450,
       toolbar:[
			['-' , 'NewPage' , 'Preview' , '-' , 'Print' , 'Templates'],
			['Cut' , 'Copy' , 'Paste' , 'PasteText' , 'PasteFromWord' , '-' , 'SpellChecker'],
			['Undo' , 'Redo' , '-' , 'Find' , 'Replace', '-' , 'SelectAll', 'Scayt' , 'RemoveFormat'],
			...
			['Link' , 'Unlink' , 'Anchor'],
			['Image' , 'Flash' , 'Table' , 'HorizontalRule' , 'SpecialChar' , 'PageBreak'],//, 'Smiley' , 'Iframe'
			'/',
	...
	initComponent : function() {
		...
		this.on("afterrender", function() {
					...
					this.editor.on("instanceReady", function() {
						this.fireEvent("instanceReady", this,
								this.editor);
							// 触发instanceReady事件
						}, this);
				}, this);

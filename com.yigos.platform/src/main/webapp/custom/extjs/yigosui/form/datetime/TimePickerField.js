/**
 * 时间输入框, 三个整数框分别输入 时,分,秒.
 */
Ext.define('Ext.yigosui.form.TimePickerField',{
	extend : 'Ext.form.field.Base',
	alias : 'widget.timepicker',
	xtype: 'ux-timepicker',
	alternateClassName : 'Ext.form.field.TimePickerField',
	requires : [ 'Ext.ux.form.NumberTextSpinnerField' ],
	...
	initComponent : function() {
		...
		me.hoursSpinner = me.createNumberField(cfg, 0, 23);
		me.minutesSpinner = me.createNumberField(cfg, 0, 59);
		// TODO 使用timeformat 判断是否创建秒输入框, maybe second field is not always need.
		me.secondsSpinner = me.createNumberField(cfg, 0, 59);
		me.spinners.push(me.hoursSpinner, me.minutesSpinner, me.secondsSpinner);

	},
	
	createNumberField : function(cfg, minValue, maxValue){
		spinner = Ext.create('Ext.ux.form.NumberTextSpinnerField',
			Ext.apply({}, cfg, {
				minValue : minValue,
				maxValue : maxValue
			}));
